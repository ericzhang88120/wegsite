...
* star
*/
function wl_reset_home_star_setting()
{
	...
	$wl_theme_options['pic_image_1']=$star_image_1;
	$wl_theme_options['pic_image_2']=$star_image_2;
	$wl_theme_options['pic_image_3']=$star_image_3;
	$wl_theme_options['pic_image_4']=$star_image_4;
	update_option('enigma_options', $wl_theme_options);
}
/*
* Service Settings
