...
<div class="block ui-tabs-panel deactive" id="option-home-star" >
	<form method="post" id="weblizar_theme_options_home-star">
		<div id="heading">
			<table style="width:100%;"><tr>
				<td cols=2 ><h2><?php _e('Star Settings','weblizar');?></h2></td>
				<td style="width:30%;">
					<div class="weblizar_settings_loding" id="weblizar_loding_home-star_image"></div>
					<div class="weblizar_settings_massage" id="weblizar_settings_save_home-star_success" ><?php _e('Options Data updated','weblizar');?></div>
					<div class="weblizar_settings_massage" id="weblizar_settings_save_home-star_reset" ><?php _e('Options data Reset','weblizar');?></div>
				</td>
				<td style="text-align:right;">					
					<input class="button" type="button" name="reset" value="Restore Defaults" onclick="weblizar_option_data_reset('home-star');">
					<input class="button button-primary" type="button" value="Save Options" onclick="weblizar_option_data_save('home-star')" >
...
<div class="block ui-tabs-panel deactive" id="option-home-event" >
	<form method="post" id="weblizar_theme_options_home-event">
		...
		<div class="section">
		<div class="panel-group" id="accordion86">
		<div class="panel panel-default">		 
			<div class="panel-heading">
				<h4 class="panel-title"> <?php _e('Event broadcast image','weblizar'); ?>
					<a data-toggle="collapse" data-parent="#accordion" href="#collapse85">
					<i class="indicator glyphicon glyphicon-chevron-down  pull-right"></i>
					</a>
				</h4>
			...
			<div class="panel-body">
			<h3><?php _e('Picture 6','weblizar'); ?></h3>
			<input class="weblizar_inpute" type="text" value="<?php if($wl_theme_options['event_image_6']!='') { echo esc_attr($wl_theme_options['event_image_6']); } ?>" id="event_image_6" name="event_image_6" size="36" class="upload has-file"/>
			<input type="button" id="upload_button" value="Image 6" class="upload_image_button" />
			<span class="explain"><?php _e('Add Pic6 here, size suggestion is 725X475.','weblizar');?></span>	
			<?php if($wl_theme_options['event_image_6']!='') { ?>
			<img style="height:475px; width:725px;" src="<?php if($wl_theme_options['event_image_6']!='') { echo esc_attr($wl_theme_options['event_image_6']); } ?>" />
			<?php } ?>
			</div>
			</div>
		</div>
		...
		<h3><?php _e('Event Broadcast Description','weblizar'); ?></h3>			
		<?php $settings = array( "media_buttons" => false,"quicktags" => false, "tinymce" => array( "plugins" => "wordpress" ) ); ?>
		<?php $content = $wl_theme_options["event_broadcast_text"]!="" ? esc_attr($wl_theme_options["event_broadcast_text"]) : "" ; ?>                     
		<?php $editor_id = "event_broadcast_text"; ?>
		<?php wp_editor( $content, $editor_id,$settings ); ?>
		<div class="explain"><?php _e('Type here broadcast info.','weblizar'); ?></div>	
...
<!--------------- what's up settings ------------>
<div class="block ui-tabs-panel deactive" id="option-home-whatisup" >
	<form method="post" id="weblizar_theme_options_home-whatisup">
		<div id="heading">
			<table style="width:100%;"><tr>
				<td cols=2 ><h2><?php _e('What\s Up Page Settings','weblizar');?></h2></td>
				<td style="width:30%;">
					<div class="weblizar_settings_loding" id="weblizar_loding_home-whatisup_image"></div>
					<div class="weblizar_settings_massage" id="weblizar_settings_save_home-whatisup_success" ><?php _e('Options Data updated','weblizar');?></div>
					<div class="weblizar_settings_massage" id="weblizar_settings_save_home-whatisup_reset" ><?php _e('Options data Reset','weblizar');?></div>
				</td>
				<td style="text-align:right;">					
					<input class="button" type="button" name="reset" value="Restore Defaults" onclick="weblizar_option_data_reset('home-whatisup');">
					<input class="button button-primary" type="button" value="Save Options" onclick="weblizar_option_data_save('home-whatisup')" >
				</td>
				</tr>
			</table>			
		</div>	
		<div class="section">
			<div class="panel-group" id="accordion81">
				<div class="panel panel-default">		 
					<div class="panel-heading">
						<h4 class="panel-title"> <?php _e('Pre-Events Picture','weblizar'); ?>
							<a data-toggle="collapse" data-parent="#accordion" href="#collapse81">
							<i class="indicator glyphicon glyphicon-chevron-down  pull-right"></i>
							</a>
						</h4>
					...
					<div id="collapse81" class="panel-collapse collapse in">
					<div class="panel-body">
					<h3><?php _e('Pre-Events Picture','weblizar'); ?></h3>
					<input class="weblizar_inpute" type="text" value="<?php if($wl_theme_options['page_what_is_up_image_1']!='') { echo esc_attr($wl_theme_options['page_what_is_up_image_1']); } ?>" id="page_what_is_up_image_1" name="page_what_is_up_image_1" size="36" class="upload has-file"/>
					<input type="button" id="upload_button" value="Image 1" class="upload_image_button" />
					<span class="explain"><?php _e('Add Pic1 here, size suggestion is 725X475.','weblizar');?></span>	
					<?php if($wl_theme_options['page_what_is_up_image_1']!='') { ?>
					<img style="height:323px; width:488px;" src="<?php if($wl_theme_options['page_what_is_up_image_1']!='') { echo esc_attr($wl_theme_options['page_what_is_up_image_1']); } ?>" />
					<?php } ?>
					</div>
					</div>
				</div>
		...
		<div class="section">
			<div class="panel-group" id="accordion81">
				<div class="panel panel-default">		 
					<div class="panel-heading">
						<h4 class="panel-title"> <?php _e('Media Release Picture 1','weblizar'); ?>
							<a data-toggle="collapse" data-parent="#accordion" href="#collapse81">
							<i class="indicator glyphicon glyphicon-chevron-down  pull-right"></i>
							</a>
						</h4>
					...
					<div id="collapse81" class="panel-collapse collapse in">
					<div class="panel-body">
					<h3><?php _e('Media Release Picture 1','weblizar'); ?></h3>
					<input class="weblizar_inpute" type="text" value="<?php if($wl_theme_options['page_what_is_up_image_2']!='') { echo esc_attr($wl_theme_options['page_what_is_up_image_2']); } ?>" id="page_what_is_up_image_2" name="page_what_is_up_image_2" size="36" class="upload has-file"/>
					<input type="button" id="upload_button" value="Image 1" class="upload_image_button" />
					<span class="explain"><?php _e('Add Pic1 here, size suggestion is 725X475.','weblizar');?></span>	
					<?php if($wl_theme_options['page_what_is_up_image_1']!='') { ?>
					<img style="height:137px; width:206px;" src="<?php if($wl_theme_options['page_what_is_up_image_2']!='') { echo esc_attr($wl_theme_options['page_what_is_up_image_2']); } ?>" />
					<?php } ?>
					</div>
					</div>
				</div>
		...
		<div class="section">
			<div class="panel-group" id="accordion81">
				<div class="panel panel-default">		 
					<div class="panel-heading">
						<h4 class="panel-title"> <?php _e('Media Release Picture 2','weblizar'); ?>
							<a data-toggle="collapse" data-parent="#accordion" href="#collapse81">
							<i class="indicator glyphicon glyphicon-chevron-down  pull-right"></i>
							</a>
						</h4>
					...
					<div id="collapse81" class="panel-collapse collapse in">
					<div class="panel-body">
					<h3><?php _e('Media Release Picture 2','weblizar'); ?></h3>
					<input class="weblizar_inpute" type="text" value="<?php if($wl_theme_options['page_what_is_up_image_3']!='') { echo esc_attr($wl_theme_options['page_what_is_up_image_3']); } ?>" id="page_what_is_up_image_3" name="page_what_is_up_image_3" size="36" class="upload has-file"/>
					<input type="button" id="upload_button" value="Image 1" class="upload_image_button" />
					<span class="explain"><?php _e('Add Pic1 here, size suggestion is 725X475.','weblizar');?></span>	
					<?php if($wl_theme_options['page_what_is_up_image_1']!='') { ?>
					<img style="height:137px; width:206px;" src="<?php if($wl_theme_options['page_what_is_up_image_3']!='') { echo esc_attr($wl_theme_options['page_what_is_up_image_3']); } ?>" />
					<?php } ?>
					</div>
					</div>
				</div>
		...
		<div class="section">
			<div class="panel-group" id="accordion81">
				<div class="panel panel-default">		 
					<div class="panel-heading">
						<h4 class="panel-title"> <?php _e('Media Release Picture 3','weblizar'); ?>
							<a data-toggle="collapse" data-parent="#accordion" href="#collapse81">
							<i class="indicator glyphicon glyphicon-chevron-down  pull-right"></i>
							</a>
						</h4>
					...
					<div id="collapse81" class="panel-collapse collapse in">
					<div class="panel-body">
					<h3><?php _e('Media Release Picture 3','weblizar'); ?></h3>
					<input class="weblizar_inpute" type="text" value="<?php if($wl_theme_options['page_what_is_up_image_4']!='') { echo esc_attr($wl_theme_options['page_what_is_up_image_4']); } ?>" id="page_what_is_up_image_4" name="page_what_is_up_image_4" size="36" class="upload has-file"/>
					<input type="button" id="upload_button" value="Image 1" class="upload_image_button" />
					<span class="explain"><?php _e('Add Pic1 here, size suggestion is 725X475.','weblizar');?></span>	
					<?php if($wl_theme_options['page_what_is_up_image_1']!='') { ?>
					<img style="height:137px; width:206px;" src="<?php if($wl_theme_options['page_what_is_up_image_4']!='') { echo esc_attr($wl_theme_options['page_what_is_up_image_4']); } ?>" />
					<?php } ?>
					</div>
					</div>
				</div>
		...
		<div class="section">
			<div class="panel-group" id="accordion81">
				<div class="panel panel-default">		 
					<div class="panel-heading">
						<h4 class="panel-title"> <?php _e('Results Picture 1','weblizar'); ?>
							<a data-toggle="collapse" data-parent="#accordion" href="#collapse81">
							<i class="indicator glyphicon glyphicon-chevron-down  pull-right"></i>
							</a>
						</h4>
					...
					<div id="collapse81" class="panel-collapse collapse in">
					<div class="panel-body">
					<h3><?php _e('Results Picture 1','weblizar'); ?></h3>
					<input class="weblizar_inpute" type="text" value="<?php if($wl_theme_options['page_what_is_up_image_5']!='') { echo esc_attr($wl_theme_options['page_what_is_up_image_5']); } ?>" id="page_what_is_up_image_5" name="page_what_is_up_image_5" size="36" class="upload has-file"/>
					<input type="button" id="upload_button" value="Image 1" class="upload_image_button" />
					<span class="explain"><?php _e('Add Pic1 here, size suggestion is 725X475.','weblizar');?></span>	
					<?php if($wl_theme_options['page_what_is_up_image_1']!='') { ?>
					<img style="height:113px; width:114px;" src="<?php if($wl_theme_options['page_what_is_up_image_5']!='') { echo esc_attr($wl_theme_options['page_what_is_up_image_5']); } ?>" />
					<?php } ?>
					</div>
					</div>
				</div>
		...
		<div class="section">
			<div class="panel-group" id="accordion81">
				<div class="panel panel-default">		 
					<div class="panel-heading">
						<h4 class="panel-title"> <?php _e('Results Picture 2','weblizar'); ?>
							<a data-toggle="collapse" data-parent="#accordion" href="#collapse81">
							<i class="indicator glyphicon glyphicon-chevron-down  pull-right"></i>
							</a>
						</h4>
					...
					<div id="collapse81" class="panel-collapse collapse in">
					<div class="panel-body">
					<h3><?php _e('Results Picture 2','weblizar'); ?></h3>
					<input class="weblizar_inpute" type="text" value="<?php if($wl_theme_options['page_what_is_up_image_6']!='') { echo esc_attr($wl_theme_options['page_what_is_up_image_6']); } ?>" id="page_what_is_up_image_6" name="page_what_is_up_image_6" size="36" class="upload has-file"/>
					<input type="button" id="upload_button" value="Image 1" class="upload_image_button" />
					<span class="explain"><?php _e('Add Pic1 here, size suggestion is 725X475.','weblizar');?></span>	
					<?php if($wl_theme_options['page_what_is_up_image_1']!='') { ?>
					<img style="height:113px; width:114px;" src="<?php if($wl_theme_options['page_what_is_up_image_6']!='') { echo esc_attr($wl_theme_options['page_what_is_up_image_6']); } ?>" />
					<?php } ?>
					</div>
					</div>
				</div>
		...
		<div class="section">
			<div class="panel-group" id="accordion81">
				<div class="panel panel-default">		 
					<div class="panel-heading">
						<h4 class="panel-title"> <?php _e('Results Picture 3','weblizar'); ?>
							<a data-toggle="collapse" data-parent="#accordion" href="#collapse81">
							<i class="indicator glyphicon glyphicon-chevron-down  pull-right"></i>
							</a>
						</h4>
					...
					<div id="collapse81" class="panel-collapse collapse in">
					<div class="panel-body">
					<h3><?php _e('Results Picture 3','weblizar'); ?></h3>
					<input class="weblizar_inpute" type="text" value="<?php if($wl_theme_options['page_what_is_up_image_7']!='') { echo esc_attr($wl_theme_options['page_what_is_up_image_7']); } ?>" id="page_what_is_up_image_7" name="page_what_is_up_image_7" size="36" class="upload has-file"/>
					<input type="button" id="upload_button" value="Image 1" class="upload_image_button" />
					<span class="explain"><?php _e('Add Pic1 here, size suggestion is 725X475.','weblizar');?></span>	
					<?php if($wl_theme_options['page_what_is_up_image_1']!='') { ?>
					<img style="height:113px; width:114px;" src="<?php if($wl_theme_options['page_what_is_up_image_7']!='') { echo esc_attr($wl_theme_options['page_what_is_up_image_7']); } ?>" />
					<?php } ?>
					</div>
					</div>
				</div>
		...
		<div class="section">
			<div class="panel-group" id="accordion81">
				<div class="panel panel-default">		 
					<div class="panel-heading">
						<h4 class="panel-title"> <?php _e('Results Picture 4','weblizar'); ?>
							<a data-toggle="collapse" data-parent="#accordion" href="#collapse81">
							<i class="indicator glyphicon glyphicon-chevron-down  pull-right"></i>
							</a>
						</h4>
					...
					<div id="collapse81" class="panel-collapse collapse in">
					<div class="panel-body">
					<h3><?php _e('Results Picture 4','weblizar'); ?></h3>
					<input class="weblizar_inpute" type="text" value="<?php if($wl_theme_options['page_what_is_up_image_8']!='') { echo esc_attr($wl_theme_options['page_what_is_up_image_8']); } ?>" id="page_what_is_up_image_8" name="page_what_is_up_image_8" size="36" class="upload has-file"/>
					<input type="button" id="upload_button" value="Image 1" class="upload_image_button" />
					<span class="explain"><?php _e('Add Pic1 here, size suggestion is 725X475.','weblizar');?></span>	
					<?php if($wl_theme_options['page_what_is_up_image_1']!='') { ?>
					<img style="height:113px; width:114px;" src="<?php if($wl_theme_options['page_what_is_up_image_8']!='') { echo esc_attr($wl_theme_options['page_what_is_up_image_8']); } ?>" />
					<?php } ?>
					</div>
					</div>
				</div>
		...
		<div class="section">
			<div class="panel-group" id="accordion81">
				<div class="panel panel-default">		 
					<div class="panel-heading">
						<h4 class="panel-title"> <?php _e('Results Picture 5','weblizar'); ?>
							<a data-toggle="collapse" data-parent="#accordion" href="#collapse81">
							<i class="indicator glyphicon glyphicon-chevron-down  pull-right"></i>
							</a>
						</h4>
					...
					<div id="collapse81" class="panel-collapse collapse in">
					<div class="panel-body">
					<h3><?php _e('Results Picture 5','weblizar'); ?></h3>
					<input class="weblizar_inpute" type="text" value="<?php if($wl_theme_options['page_what_is_up_image_9']!='') { echo esc_attr($wl_theme_options['page_what_is_up_image_9']); } ?>" id="page_what_is_up_image_9" name="page_what_is_up_image_9" size="36" class="upload has-file"/>
					<input type="button" id="upload_button" value="Image 1" class="upload_image_button" />
					<span class="explain"><?php _e('Add Pic1 here, size suggestion is 725X475.','weblizar');?></span>	
					<?php if($wl_theme_options['page_what_is_up_image_1']!='') { ?>
					<img style="height:113px; width:114px;" src="<?php if($wl_theme_options['page_what_is_up_image_9']!='') { echo esc_attr($wl_theme_options['page_what_is_up_image_9']); } ?>" />
					<?php } ?>
					</div>
					</div>
				</div>
		...
		<div class="section">
			<div class="panel-group" id="accordion81">
				<div class="panel panel-default">		 
					<div class="panel-heading">
						<h4 class="panel-title"> <?php _e('Results Picture 6','weblizar'); ?>
							<a data-toggle="collapse" data-parent="#accordion" href="#collapse81">
							<i class="indicator glyphicon glyphicon-chevron-down  pull-right"></i>
							</a>
						</h4>
					...
					<div id="collapse81" class="panel-collapse collapse in">
					<div class="panel-body">
					<h3><?php _e('Results Picture 6','weblizar'); ?></h3>
					<input class="weblizar_inpute" type="text" value="<?php if($wl_theme_options['page_what_is_up_image_10']!='') { echo esc_attr($wl_theme_options['page_what_is_up_image_10']); } ?>" id="page_what_is_up_image_10" name="page_what_is_up_image_10" size="36" class="upload has-file"/>
					<input type="button" id="upload_button" value="Image 1" class="upload_image_button" />
					<span class="explain"><?php _e('Add Pic1 here, size suggestion is 725X475.','weblizar');?></span>	
					<?php if($wl_theme_options['page_what_is_up_image_1']!='') { ?>
					<img style="height:113px; width:114px;" src="<?php if($wl_theme_options['page_what_is_up_image_10']!='') { echo esc_attr($wl_theme_options['page_what_is_up_image_10']); } ?>" />
					<?php } ?>
					</div>
					</div>
				</div>
		...
		<div id="button_section">
			<input type="hidden" value="1" id="weblizar_settings_save_home-whatisup" name="weblizar_settings_save_home-whatisup" />			
			<input class="button" type="button" name="reset" value="Restore Defaults" onclick="weblizar_option_data_reset('home-whatisup');">
			<input class="button button-primary" type="button" value="Save Options" onclick="weblizar_option_data_save('home-whatisup')" >
			<!--  alert massage when data saved and reset -->
		</div>
