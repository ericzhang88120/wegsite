...
<div class="container">
	<div class="row" id="pearl" style="background: #272727 url(wp-content/themes/wegsite/images/action/pearl/bg.png) no-repeat; height:862px;padding:127px 0 0 0;">
		...
		<div class="actiondes" style="padding:0 20px 0 20px;height:200px">
			...
			<p>Following the success of the Bund Stunt in 2014, the Oriental Pearl Jam will be the curtain-raiserto the main KWEG competition starting from 28 April 2015.  Held against the iconic backdrop of the Oriental Pearl Tower, it will set the scene for the BMX and Skateboard Vert competition held on 28 & 29 April at the same venue and will be a guaranteed spectacle.</p>
	...
	<?php get_template_part('action','street'); ?>
		<div class="actiondes" style="padding:0 20px 0 20px">
			...
			<p>For the very first time, the street course competition will be moved from inside Jiangwan Stadium to out on the streets (literally); as the organisers aim to keep the action authentic within a natural yet competitive setting.</p>
	...
	<?php get_template_part('action','moto'); ?>
			<div class="actiondes" style="padding:0 20px 0 20px">
			<h4>MOTO CROSS</h4>
			<p>Ever the perennial crowd favourite, Motocross will return to Jiangwan Stadium once again with some of the world’s best FMX riders thrilling and wowing the audience with their perfectly-timed stunts & jumps.</p>
			<p>Adrenaline-charged and high octane, no true action sports fan would want to miss any bit of this exhilarating action!</p>
		</div>		
	</div>
</div>
<?php get_footer(); ?>